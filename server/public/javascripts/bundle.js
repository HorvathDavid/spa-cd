...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  var Parent = __webpack_require__(1);
	  var _ = __webpack_require__(91);
	  var adl = __webpack_require__(93);
	  ...
	  React.render(React.createElement(Parent, null), document.getElementById('mountPoint'));
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  _onDatePickerChange: function _onDatePickerChange(date) {
	    console.error(date);
	    this.setState({
	      date: date
	    });
	  ...
	  _onSubmit: function _onSubmit(e) {
	    ...
	    window.adl.post(options).then(function (data) {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'container col-md-offset-4 col-md-4 col-xs-12' },
	      React.createElement(
	        'form',
	        null,
	        React.createElement(
	          ...
	          React.createElement('input', { type: 'text', className: 'form-control required', ref: 'name', id: 'name', placeholder: 'Your name here', required: true })
	        ),
	        React.createElement(
	          'div',
	          { className: 'form-group' },
	          ...
	          React.createElement('input', { type: 'email', className: 'form-control required', ref: 'email', id: 'email', placeholder: 'Email', required: true })
	        ),
	        React.createElement(
	          'div',
	          { className: 'form-group' },
	          ...
	          React.createElement('input', { type: 'text', className: 'form-control', ref: 'profession', id: 'profession', placeholder: 'Profession' })
	        ),
	        React.createElement(
	          'div',
	          { className: 'form-group pull-right' },
	          React.createElement(Datepicker, { onChange: this._onDatePickerChange })
	        ),
	        React.createElement(
	          'button',
	          { type: 'submit', ref: 'submit', className: 'btn btn-default', onClick: this._onSubmit },
	          'Submit'
	        )
	      )
	    );
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        ' Birthdate: ',
	        React.createElement('input', { type: 'text', ref: 'datepicker' })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  function n(n) {
	    ...
	    return "" + this._wrapped;
	  }, "function" == "function" && __webpack_require__(92) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return m;
